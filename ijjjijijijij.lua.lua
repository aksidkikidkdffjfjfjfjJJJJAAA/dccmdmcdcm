...
{name = "即終了(PC不可)",
   qwordtext = "6,124,894,029,145,513,984;-486,377,312,242,106,709;-5,476,375,729,656,558,999:9",
   hex = "00 10 24 1E",
   off_hex = "00 20 21 1E",
...
{name = "ツム消し即終了",
   qwordtext = "-7,997,597,852,454,877,407;-7,769,889,139,347,762,400:5",
   hex = "20 07 00 54",
   off_hex = "21 07 00 54",
...
{name = "スタート演出無効",
   qwordtext = "6,052,839,570,433,712,128;4,127,085,512,664,023,429:5",
   hex = "01 10 28 1E",
   off_hex = "01 10 2F 1E",
   assnbly = "~A8 FCMP S0, S1"
},
...
{name = "リザルト演出無効",
   qwordtext = "-486,385,735,394,327,564;-5,476,376,730,383,940,928:5",
   hex = "34 00 80 52",
   off_hex = "F4 03 01 2A",
   assnbly = "~A8 MOV W20, W1"
},
...
{name = "ガチャスキップ",
   qwordtext = "-6,268,592,876,259,556,353;-504,381,203,852,198,915;-6,268,069,538,118,495,241;-6,267,796,869,166,704,650;-7,998,318,181,468,581,900;-3,081,640,445,491,526,659;-6,196,667,348,100,067,241:25",
   hex = "C0 03 5F D6",
   off_hex = "68 03 40 F9",
...
{name = "ツムレベル",
   qwordtext = "-7,769,866,103,290,854,143;-5,097,720,286,276,754,446:5",
   hex = "01 20 A0 52",
   off_hex = "21 05 00 11",
...
{name = "タップ速度倍速",
   qwordtext = "-3,816,518,074,843,002,848;-7,052,072,959,295,815,416:5",
   hex = "20 08 20 1E",
   off_hex = "20 08 20 1E",
...
{name = "キャンセルボタン無効",
   qwordtext = "-3,386,350,679,824,343,035;-6,268,311,401,282,845,697:5",
   hex = "C0 03 5F D6",
   off_hex = "68 03 40 F9",
   assnbly = "~A8 SUB SP, SP, #0x50"
},
...
{name = "スコアカンスト",
   qwordtext = "-6,196,948,744,345,156,620;-961,925,714,850,872,333;5,334,800,915,614,829,992:9",
   hex = "14 00 B0 52",
   off_hex = "F4 03 01 2A",
   assnbly = "~A8 MOV W20, W1"
},
