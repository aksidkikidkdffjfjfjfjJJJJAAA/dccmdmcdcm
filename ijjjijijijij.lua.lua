...
{name = "リザルト演出無効",
   qwordtext = "-7,998,283,123,781,467,148;-7,768,834,140,761,201,696;-1,152,774,545,519,702,398;-4,809,841,649,226,054,232:13",
   hex = "34 00 80 52",
   off_hex = "F4 03 01 2A",
   assnbly = "~A8 MOV W20, W1"
},
...
{name = "ガチャスキップ",
   qwordtext = "-549,857,339,113,389,057;-549,734,188,855,688,279;-7,998,321,431,427,484,758;-576,159,032,713,133,816:13",
   hex = "C0 03 5F D6",
   off_hex = "68 03 40 F9",
...
{name = "スコアカンスト",
   qwordtext = "-1,510,674,966,645,767,180;6,052,838,319,741,010,207;-6,191,600,800,687,456,159;-7,768,947,024,965,991,456:13",
   hex = "14 00 B0 52",
   off_hex = "F4 03 01 2A",
   assnbly = "~A8 MOV W20, W1"
},
